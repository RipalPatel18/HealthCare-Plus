    ...
    <div class="container py-5">
      <div class="row g-4">
        ...
        <div class="col-6 col-lg-2">
          <h6 class="footer-title">Admin Links</h6>
          <ul class="list-unstyled footer-links">
            <li><a href="{{ url('/admin/dashboard') }}">Dashboard</a></li>
            <li><a href="{{ url('/admin/manage-doctors') }}">Manage Doctors</a></li>
            <li><a href="{{ url('/admin/manage-services') }}">Manage Services</a></li>
            <li><a href="{{ url('/admin/manage-departments') }}">Manage Departments</a></li>
          </ul>
        </div>
